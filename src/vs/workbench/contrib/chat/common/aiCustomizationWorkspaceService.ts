...
/** Legacy type alias retained for compatibility with 1.118.1 sessions code. */
export type AICustomizationPromptsStorage = AICustomizationSource | 'builtin';

/** Legacy interface retained for compatibility with 1.118.1 sessions code. */
