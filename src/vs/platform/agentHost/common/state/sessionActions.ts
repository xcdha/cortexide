...
// Legacy type aliases (retained for compatibility with 1.118.1 code)
export type SessionErrorAction = IErrorAction;
export type SessionInputRequestedAction = ChatInputRequestedAction;
export type SessionToolCallContentChangedAction = IToolCallContentChangedAction;
export type SessionToolCallReadyAction = IToolCallReadyAction;
export type SessionResponsePartAction = IResponsePartAction;
export type SessionDiffsChangedAction = IIsReadChangedAction;
export type SessionToolCallStartAction = IToolCallStartAction;

// Legacy notification type aliases
export type SessionAddedNotification = Extract<ProtocolNotification, { type: 'root/sessionAdded' }>;
