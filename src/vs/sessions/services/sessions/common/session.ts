...
/** Session type ID for Copilot CLI sessions. */
...
/**
 * Legacy repository interface retained for compatibility with sessions providers
 * restored from 1.118.1. New code should use {@link ISessionGitRepository}.
 */
